                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class="form-control-static"><code>${userAuthorizationUri}</code>
                            &nbsp;<a href="{{userAuthorizationUri}}?response_type={{responseType}}&scope={{scope}}&client_id={{clientId}}&redirect_uri={{redirectUri}}&state={{state}}" target="_blank">测试连接</a>
                        </p>
...
<script>
    var AuthorizationCodeCtrl = ['$scope', function ($scope) {
        ...
        $scope.clientId = '8fbc994a-b377-11e5-8515-1c872c426276';
